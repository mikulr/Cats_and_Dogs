var mapboxAccessToken = mapAPI;
// console.log(mapAPI)
// console.log(parksHapiness)
...
var happyface = L.icon({
    iconUrl: '/static/Resources/smiley.png',
});
...
//pets marker
var peticon = L.icon({
    iconUrl: '/static/Resources/pets.png',
});
...
//dogs marker
var dogicon = L.icon({
    iconUrl: '/static/Resources/dog.png',
});
...
//cat marker
var caticon = L.icon({
    iconUrl: '/static/Resources/cat.png',
});
...
var cashmoney = L.icon({
    iconUrl: '/static/Resources/money.png',
});
...
var violence = L.icon({
    iconUrl: '/static/Resources/crime.png',
});
...
//colleges marker
var books = L.icon({
    iconUrl: '/static/Resources/books.png',
});
...
//tree icon marker
var tree = L.icon({
    iconUrl: '/static/Resources/tree.png',
});
